...
import { DetailedPost } from '../interfaces'

interface PostDetailInterface {
  post: DetailedPost
}
const PostDetail: React.FC<PostDetailInterface> = ({ post }) => {
  const getContentFragment = (
    index: number,
    text: String | any | ReactElement,
    obj: any,
    type?: String
  ) => {
      ...
      case 'heading-three':
        return (
          <h3 key={index} className="mb-4 text-xl font-semibold">
            {modifiedText.map((item: String | any, i: number) => (
